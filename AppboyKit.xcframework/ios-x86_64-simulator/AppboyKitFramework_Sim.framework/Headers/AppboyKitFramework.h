...
//! Project version number for AppboyKitFramework.
FOUNDATION_EXPORT double AppboyKitFrameworkVersionNumber;

//! Project version string for AppboyKitFramework.
FOUNDATION_EXPORT const unsigned char AppboyKitFrameworkVersionString[];
